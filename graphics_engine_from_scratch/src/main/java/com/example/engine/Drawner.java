...
import com.example.engine.beans.CameraVirtual;
import com.example.engine.beans.Cor;
import com.example.engine.beans.Iluminacao;
import com.example.engine.beans.Objeto;
import com.example.engine.beans.Ponto;
import com.example.engine.beans.Triangulo;
import com.example.engine.beans.Vetor;
import com.example.engine.beans.ZBuffer;
...
public class Drawner{
	...
	/**
	 * Fun��o principal, que far� todo o algoritmo de renderiza��o
	 * @param canvas
	 * @param camera
	 * @param objeto
	 * @param light
	...
	public static void renderizar(Canvas canvas, CameraVirtual camera, Objeto objeto, Iluminacao ilumination) throws NegocioException {
		...
		// agora os vertices de vista j� est�o com suas normais atribuidas
    ...
    /**
     * Calcula a cor de um ponto com a ilumina��o de phong
     * case o ponto esteja fora dos limites da tela (width, height), ele n�o ser� calculado
     * � nesta etapa que preenchemos os pixels a serem pintados no ZBuffer
     * @param ponto
     * @param triangulo
     * @param width
     * @param height
    ...
    /**
     * Baseado nos pixels armazenados no ZBuffer, � realizada
